...
class ImportKeystoreModal extends React.Component {
  specifyName = (event) => {
    ...
    return (
      <div className="import-account text-green">
        <div className="modal-title">
          <div className="left">
            <i className="k-icon k-icon-account"></i>Import account
          </div>
          <div className="right">
...
export default connect(mapStateToProps)(ImportKeystoreModal);
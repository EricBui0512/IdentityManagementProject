...
class DeployWalletModal extends React.Component {
    ...
    return (
      <div className="import-account">
        <div className="modal-title">
          <div className="left">
            <i className="k-icon k-icon-account"></i>Create a Kyber Wallet
          </div>
          <div className="right">
...
export default connect(mapStateToProps)(DeployWalletModal);
  ...
  render() {
    ...
    if (this.props.error && this.props.error != "") {
      error = (<div className="error">
        <i className="k-icon k-icon-error"></i>
        Selected address is {this.props.error}
      </div>)
    }
    return (
      <div className="input-group-item input-account">
        <label>Account</label>
        <div className="input-item">
          <input value={this.props.selectedAccount} type="text" disabled placeholder="Choose your account to create wallet"/>
          <div className="select-wrapper">
            <select className="selectric" id="from-account" value={this.props.selectedAccount} onChange={this.selectAccount}>
